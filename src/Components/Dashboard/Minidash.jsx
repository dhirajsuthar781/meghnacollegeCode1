...
function Minidash({ showing }) {
    ...
    return (
        <>
                ...
                <div className='w-full  font-Poppins  font-normal space-y-2  px-[1%]'>
                    <div className='w-full   '>
                        <table className=' w-full table-auto'>
                            <thead >
                                <tr id='tableHeading' className='text-[18px] bg-[#fc1d1d] text-white font-normal text-center'>
                                                ...
                                                <tr key={index} className='text-[16px] text-center'>
                                                    ...
                                                    <td className='py-3'>
                                                        ...
                                                        <div className='flex justify-center  items-center gap-5'>
                                                            <div className=' '>
                                                                {/*  */}
                                                                <img onClick={() => showing.whatsapp(k)} src="./img/whatspp.png" alt="whatapp" title='Whatsapp to Student' className=' h-7  ' />
                                                            </div>
                                                            <div className=' '>
                                                                <img onClick={() => showing.EditStudent(k)} src="./img/edit.png" alt="whatapp" title='Whatsapp to Student' className=' h-6  ' />

                                                            </div>
                                                            <div className=' '>

                                                                <img onClick={() => showing.deleteStudent(k)} src="./img/delete.png" alt="whatapp" title='Whatsapp to Student' className=' h-8  ' />
                                                            </div>
                                                        </div>
                                                    </td >
                                                </tr>
            ...
            <div id='editpop' className='hi w-full px-[6%] bg-[#efefef14] mb-8  py-10 font-Poppins text-[#303030]'>
                ...
                <div className='w-full px-[6%] flex justify-center items-center pt-10 pb-5 gap-7'>
                    <button onClick={showing.updateEditStudent} className='border-[2px] text-[16px] border-[#ed473c] rounded-lg py-1 w-[150px] flex justify-center items-center font-Poppins text-[#ed473c] ed473c:bg-[#ffffffad]'>Update</button>
                    <button onClick={showing.cancleEditStudent} className='border-[2px] text-[16px] border-[#ed473c] rounded-lg py-1 w-[150px] flex justify-center items-center font-Poppins text-[#ed473c] ed473c:bg-[#ffffffad]'>Cancle</button>
                </div>
